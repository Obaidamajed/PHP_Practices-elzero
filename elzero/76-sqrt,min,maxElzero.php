<?php
  ...
  */
  ...
  echo "<pre>";
  print_r(min([1, 3, 5], [1, 2, 6])); // بطبع الأرراي الثاني لأن اول عدد بيناتهم متساوي والعدد الثاني في الأرراي الثاني هو الاصغر
  echo "</pre>";
  ...
  echo "<pre>";
  print_r(max([1, 3, 5], [1, 2, 6])); // بطبع الأرراي الاول
  echo "</pre>";